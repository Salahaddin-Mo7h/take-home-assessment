...
void main() {
  ...
  group('CacheService Error Handling Tests', () {
    ...
    test('cacheMarketData should handle errors and throw CacheException', () async {
    ...
    test('getCachedMarketData should handle parsing errors gracefully', () async {
      // Set invalid JSON
    ...
    test('getCachedMarketData should execute cache expiration check', () async {
      final testData = [{'symbol': 'BTC/USD', 'price': 43250.50}];
      await cacheService.cacheMarketData(testData);
    ...
    test('getCachedMarketData should execute clearCache on expiration', () async {
      // Set expired cache
      final prefs = await SharedPreferences.getInstance();
    ...
    test('should handle cache operations with various data formats', () async {
      final data1 = [{'symbol': 'BTC/USD', 'price': 43250.50}];
      final data2 = [{'symbol': 'ETH/USD', 'price': 2650.75, 'volume': 1000000}];
